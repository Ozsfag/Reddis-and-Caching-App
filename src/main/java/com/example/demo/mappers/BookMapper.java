...
public interface BookMapper {
  ...
  @Mapping(target = "categoryDto", qualifiedByName = "categoryToCategoryDto", source = "book.category")
  ...
  @Mapping(target = "title", source = "bookDto.title")
  @Mapping(target = "author", source = "bookDto.author")
  @Mapping(target = "category", qualifiedByName = "categoryDtoToCategory", source = "bookDto.categoryDto")
